...
import 'package:poolq/Module/Screen/Home/picked.dart';
...
class _LeaderboardWidgetState extends State<LeaderboardWidget> {
  ...
  Future getGame(context, selectedValue) async {
    ...
    var response =
    await http.get(Uri.parse('https://poolq.app/getnlf/${dataProvider.game!["mode"]}$selectedValue'), headers: {
  ...
  // https://poolq.app/getnlf/${dataProvider.game!["mode"]}${widget.selectedValue}
  Future getLeaderBoard(context, selectedValue) async {
    DataProvider dataProvider =
    Provider.of<DataProvider>(context, listen: false);
    var response = await http.get(
        Uri.parse('https://poolq.app/getleaderboard/${dataProvider.game!["mode"]}$selectedValue'),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
        }).timeout(const Duration(seconds: 20));
    var body = json.decode(response.body);
  ...
  void initState() {
    ...
    DataProvider dataProvider =
        Provider.of<DataProvider>(context, listen: false);
    selectedValue = dataProvider.game!["name"].toString().replaceAll("REG", "").replaceAll("PRE", "");
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    }else if(dataProvider.game!["mode"]=="PRE"){
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(): dataProvider.game!["mode"]=="REG"? Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0, 0, 0, 0),
                                        child: Text(
                                        ...
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0, 0, 0, 0),
                                        child: Text(
                                          'PRESEASON: $selectedValue '.toUpperCase(),
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontFamily: 'Poppins',
                          ...
                          Padding(
                            padding:
                                const EdgeInsetsDirectional.fromSTEB(20, 23, 0, 0),
                            child: Text(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: 70,
                                    decoration: BoxDecoration(
                                      color: normal_data![0]["uid"]==data![index]["uid"]?null:const Color(0xFF3474E0),
                                      image: normal_data![0]["uid"]==data![index]["uid"]?const DecorationImage(
                                          image: AssetImage("assets/images/winner.png"),
                                          fit: BoxFit.cover
                                      ):null,
                                      boxShadow: const [
                    ...
                    child: Align(
                      ...
                      child: TextButton(
                        ...
                        child: Ink(
                          ...
                          child: Container(
                            constraints:
                                const BoxConstraints(maxWidth: 100, minHeight: 34.0),
